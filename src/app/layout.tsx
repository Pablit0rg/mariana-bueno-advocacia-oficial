...
import { inter } from "./fonts"; // <--- Mudamos para Inter
...
// (Mantenha as configs de Viewport e Metadata iguais, não precisa mudar)
...
export const metadata: Metadata = {
  ...
  keywords: ["Advogada de Família", "Divórcio Empresarial", "Partilha de Bens", "Inventário Judicial", "Advocacia Premium Curitiba", "Direito Sucessório", "Mariana Bueno"],
  ...
  openGraph: {
    ...
    images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "Dra. Mariana Bueno - Escritório Digital" }],
  },
  twitter: {
...
export default function RootLayout({
  ...
  return (
    <html lang="pt-br" className="scroll-smooth">
      {/* Aplicando a fonte Inter globalmente */}
