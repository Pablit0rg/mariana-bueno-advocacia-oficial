    ...
    <section id="sobre" className="py-24 bg-rich-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-stretch">
          ...
          {/* COLUNA 1: A FOTO (COM A BORDA DOURADA GRUDADA) */}
          <div className="relative group">
            {/* AQUI ESTÁ A MUDANÇA:
               Adicionei 'border border-gold-primary/30' nesta linha abaixo.
               Ela fica grudada na imagem, sem padding.
            */}
            <div className="relative w-full aspect-[3/4] md:aspect-[4/5] overflow-hidden rounded-lg shadow-2xl border border-gold-primary/30">
