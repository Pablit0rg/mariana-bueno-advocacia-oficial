...
export function Footer() {
  ...
  return (
    /* --- AJUSTES DE MATEMÁTICA VISUAL ---
       1. pt-10 pb-6: Reduzi drasticamente a altura (antes era pt-16).
       2. border-t: Mantive a linha fina para separar, mas suave.
    */
    <footer className="bg-rich-black border-t border-gold-primary/20 relative pt-10 pb-6">
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        {/* --- GRID DE ALINHAMENTO PERFEITO ---
           items-start: Garante que "Mariana Bueno" e "Informações Legais" comecem EXATAMENTE na mesma linha pixel-perfect.
           gap-8: Reduzi o espaçamento entre colunas para ficar mais compacto.
        */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 items-start">
          ...
          <div className="space-y-5">
            ...
            {/* Mobile Only Text */}
            <p className="md:hidden text-gray-400 text-xs leading-relaxed max-w-xs">
              Advocacia estratégica focada na proteção do seu patrimônio.
            </p>
          </div>

          {/* Coluna 2: Legal 
             Alinhada matematicamente à direita (md:text-right) e ao topo (items-start do grid pai).
          */}
